...
import { COLOR, SIZES, icon, images, FONTS, COLORS } from '../constants'
            ...
            .then(data => {
                let areaData = data.map(item => {
                    ...
                    return {
                        ...
                        flag: `https://flagcdn.com/h40/${item.alpha2Code.toLowerCase()}.png`
                    }
                })
                setAreas(areaData)
        ...
        return (
            ...
            >
                ...
                <View style={{ marginTop: SIZES.padding * 2 }}>
                    ...
                    >
                        <Image
                            source={showPassword ? icon.disable_eye : icon.eye}
